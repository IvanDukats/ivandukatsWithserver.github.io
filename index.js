...
// Функция для обработки нажатия на кнопку Info
function onButtonInfo1Click() {
    var newPageInfoLink = document.createElement('a');

    newPageInfoLink.href = 'info.html';
...
document.getElementById('info').addEventListener('click', onButtonInfo1Click);
